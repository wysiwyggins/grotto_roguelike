...
//howler.j object for our sound sprites goes here:
/* const sound = new Howl({
    src: ['path_to_audio_sprite_file.mp3'],
    sprite: {
        footstep: [start_time, duration_time] // replace start_time and duration_time with actual values from the .json file generated by audiosprite
